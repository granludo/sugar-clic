...
class Peca(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if teclas[K_a] or (teclas[K_SPACE] or pygame.mouse.get_pressed()[0]) and (self.rect.x > self.cordx-20 and self.rect.x < self.cordx+20 and self.rect.y > self.cordy-20 and self.rect.y<self.cordy+20):
...
class Activitat:
	...
	imatges = ["ejemplo1.jpg", "ejemplo21.jpg", "ejemplo31.jpg"]
