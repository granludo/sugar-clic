...
class Peca(pygame.sprite.Sprite):
	...
	# Gestionem si el ratoli esta apretat que no vagi suman fallos
        if pygame.mouse.get_pressed()[0] and not self.apretat and self.app:
	    self.apretat = True
 	    #print "no apretat"
            self.fallat = True
	...
	if (pygame.mouse.get_pressed()[0] and x>300 and x<500 and y>620 and y<820):
            self.app = True
            self.apretat = True
            pygame.mouse.set_visible(False)
            pygame.mouse.set_pos([400,720])
